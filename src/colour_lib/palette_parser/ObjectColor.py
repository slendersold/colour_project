...
class ObjectColor:
    ...
    def calculate_rgb(self, coordinates, zarr, filter="_1000"):
        ...
        coordinates_filtered = {key: value for key, value in coordinates.items() if (filter in key) and ("rect" not in key)}
    ...
    def plot_palette(self, obj_rgb):
        ...
        color_grid = np.zeros((7, 4, 3))  # Assuming 7 rows and 4 columns for CA and A-D with 1-6
